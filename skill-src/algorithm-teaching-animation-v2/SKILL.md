...
- 若畫面包含 panel、legend、圖標籤、動態文字、表格、字幕或結論文字，使用 `references/manim-layout-audit.md` 中的 layout audit helper 檢查重疊、貼邊與溢出問題，並用實際 render/靜止幀核對 warning 是否為真問題
...
- `references/manim-layout-audit.md`
- `references/modes.md`
...
- RENDER AND REVIEW 階段：優先讀 `rendering.md`；若需要自動檢查 Manim 排版、重疊、貼邊或 panel/字幕文字溢出，讀 `manim-layout-audit.md`
